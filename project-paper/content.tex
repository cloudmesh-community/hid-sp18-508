...
\def\paperstatus{80} % a number from 0-100 indicating your status. 100
                % means completed
\def\paperchapter{Database} % This section is typically a single keyword. from
                   % a small list. Consult with theinstructors about
                   % yours. They typically fill it out once your first
                   % text has been reviewed.
\def\hid{hid-sp18-508} % all hids of the authors of this
...
\keywords{\locator\ Cassandra, MongoDB, Raspberry Pi, Google Cloud}
...
Compare insert 1000 data 1000 times on Mac, Raspberry Pi and Google 
Cloud~\ref{f:fly}.
...
Compare insert 10000 data 1000 times on Mac, Raspberry Pi and Google 
Cloud~\ref{f:fly}.
...
Compare search 5000 data 1000 times on Mac, Raspberry Pi and Google 
Cloud~\ref{f:fly}.
